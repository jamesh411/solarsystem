...
Planet mercury = new Planet("mercury", 1, 3.7, 4879, 57.9E6, 88, 360010253L);
Planet venus = new Planet("venus", 2, 8.9, 12104, 108.2E6, 224.7, 679947840L);
Planet earth = new Planet("earth", 3, 9.8, 12756, 149.6E6, 365.2, 939856896L);
Planet mars = new Planet("mars", 4, 3.7, 6792, 228.0E6, 687, 1429097472L);
Planet jupiter = new Planet("jupiter", 5, 23.1, 142984, 778.5E6, 4331, 4887577728L);
Planet saturn = new Planet("saturn", 6, 9, 120536, 1432.0E6, 10747, 8957447770L);
Planet uranus = new Planet("uranus", 7, 8.7, 51118, 2867.0E6, 30589, 18026744947L);
Planet neptune = new Planet("neptune", 8, 11, 49528, 4515.0E6, 59800, 28263782131L);
